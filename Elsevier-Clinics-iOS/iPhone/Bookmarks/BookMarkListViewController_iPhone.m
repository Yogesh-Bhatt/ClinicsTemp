//
//  BookMarkListViewController_iPhone.m
//  Clinics
//
...
@implementation BookMarkListViewController_iPhone
@synthesize m_scrollView;
@synthesize openSectionIndex;
@synthesize sectionInfoArray;
@synthesize isShowPopOverView;
@synthesize m_tblClinics;
@synthesize bookmarkDetails_iPhone;
...
- (void) addButtons
{
    ...
    m_arrCategoryImage  = [[NSMutableArray alloc] initWithObjects:
                           ...
                           @"TblCellSurgery",
                           @"TblCellEmergency1",
						   @"TblCellPrimary",@"TblCellPrimary",nil];
	...
	if ([m_arrCategory count] == 0) {
		...
		noBookmarkLbl.text = @"To add bookmarks, tap the star that appears with any article.";

		noBookmarkLbl.numberOfLines=3;
		noBookmarkLbl.frame=CGRectMake(20, 10, 290, 66);
...
- (void)initClinicListView
{
	...
	if ([m_arrButtonCategory count ]>latButtontag) {
        
        // ************************ Open And  Hide Category ***********************
		[self categoryButtonPressed:[m_arrButtonCategory objectAtIndex:latButtontag]];
	 }
	else {
...
{    
    ...
    //NSLog(@"%@",sectionInfoObj.issueArray);
...
{	
    ...
    BookMarksDetailsViewController_iPhone    *bookmarksDetails_iPhone=[[BookMarksDetailsViewController_iPhone alloc] initWithNibName:@"BookMarksDetailsViewController_iPhone" bundle:nil];
	bookmarksDetails_iPhone.m_clinicDataHolder = clinicDataHolder;
	SectionInfo *sectionInfoObj = (SectionInfo *)[self.sectionInfoArray objectAtIndex:indexPath.section];
	...
	bookmarksDetails_iPhone.categoryName=catgeryName;
	bookmarksDetails_iPhone.m_issueDataHolder = issueDataHolder;
	
	[appDelegate.navigationController pushViewController:bookmarksDetails_iPhone animated:YES];
	bookmarkDetails_iPhone=bookmarksDetails_iPhone;
	[bookmarksDetails_iPhone setClinicDetailView];
	[bookmarksDetails_iPhone  release];
}
...
//********************* here remember Which category last Selected*************************
