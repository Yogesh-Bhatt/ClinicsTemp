//
//  BookMarkListViewController_iPad.h
//  Clinics
//
...
@interface BookMarkListViewController_iPad :TabBarClassHomeView <TableCellViewDelegate, UITableViewDataSource, UITableViewDelegate, UITabBarDelegate> {
